          ...
          {filtered.map((update: any, i: number) => (
            ...
            >
              <Link
                ...
                className="glass-card flex flex-col h-full rounded-xl overflow-hidden group hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-0.5 transition-all duration-250 border border-border/40"
              >
                ...
                <div className="p-3 flex flex-col flex-1 bg-background/30 relative">
                  <div className="flex items-start gap-2 mb-auto">
                    <Bell className="w-4 h-4 mt-0.5 shrink-0 text-primary/70" />
