    ...
    <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-[100] flex justify-center items-center p-4 md:p-8">
      ...
      >
        ...
        <div className="flex flex-col pb-10">
          ...
          <div className="px-6 md:px-10 pt-6 space-y-5 z-20">
            ...
            {update.content && (
              <p className="text-slate-300 whitespace-pre-wrap text-base md:text-lg leading-relaxed mt-2">
                {update.content}
              </p>
            )}
            ...
            <div className="mt-8 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-center sm:text-left">
                <p className="text-sm font-semibold text-white">Get Notified First 🚀</p>
                <p className="text-xs text-slate-400">Join for fresh updates & resources</p>
              </div>
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366]/20 transition-colors text-xs font-medium border border-[#25D366]/20"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-[#0088cc]/10 text-[#0088cc] hover:bg-[#0088cc]/20 transition-colors text-xs font-medium border border-[#0088cc]/20"
                >
