...
export default function NewsletterForm({
  ...
  const wrapper =
    variant === "card"
      ? "glass-card-static rounded-3xl p-6 md:p-8"
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-3">
        <div
          className="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-primary/20 to-primary/5 ring-1 ring-primary/20"
          aria-hidden="true"
        >
